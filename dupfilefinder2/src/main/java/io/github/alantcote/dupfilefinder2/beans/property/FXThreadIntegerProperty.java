package io.github.alantcote.dupfilefinder2.beans.property;

import javafx.application.Platform;
import javafx.beans.property.SimpleIntegerProperty;

/**
 * A {@link SimpleIntegerProperty} that only has its value mutated in the JavaFX
 * application thread.
 * 
 ...
 */
public class FXThreadIntegerProperty extends SimpleIntegerProperty {

	/**
	 * Default constructor.
	 */
	public FXThreadIntegerProperty() {
		super();
	}
	 ...
	 */
	public FXThreadIntegerProperty(int initialValue) {
		super(initialValue);
	}
	 ...
	 */
	public FXThreadIntegerProperty(Object bean, String name) {
		super(bean, name);
	}
	 ...
	 * @param initialValue the initial value of the wrapped value
	 */
	public FXThreadIntegerProperty(Object bean, String name, int initialValue) {
	 ...
	 */
	private void superSet(int newValue) {
		super.set(newValue);
	}
